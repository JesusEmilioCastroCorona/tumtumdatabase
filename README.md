...
Este proyecto consiste en un **Sistema de Biblioteca** desarrollado en **Python** utilizando **Programación Orientada a Objetos (POO)** y **encapsulamiento**, con persistencia de datos mediante una base de datos **MySQL**.
...
4. Configurar el archivo `Base de datos.py` con los datos de tu conexión MySQL.
